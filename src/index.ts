...
} as Record<string, TSESLint.AnyRuleModule>;
...
const libraryRules: TSESLint.FlatConfig.Rules = {
...
const migrationRules: TSESLint.FlatConfig.Rules = {
  ...recommendedRules,
...
Object.assign(plugin.configs, {
  recommended: [
    { plugins: { 'sf-plugin': plugin }, rules: recommendedRules },
  ],
  library: [
    { plugins: { 'sf-plugin': plugin }, rules: libraryRules },
  ],
  migration: [
    { plugins: { 'sf-plugin': plugin }, rules: migrationRules },
  ],
});
